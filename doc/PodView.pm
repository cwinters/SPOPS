...
# $Id: PodView.pm,v 1.2 2004/06/02 00:48:24 lachoy Exp $
...
$INTERNAL_DOC_PATH  = '/doc';
$INTERNAL_DOC_EXT   = '.shtml';
...
that comes with L<Pod::POM|Pod::POM> for use in generating SPOPS
documentation. Most everything in the view is hunky dorey, but a few
things need to be customized. The overriding methods here do that.
...
If this is an SPOPS module, generate a link where we translate the
'::' to '/', add '.html' and put the link underneath a particular
path.
